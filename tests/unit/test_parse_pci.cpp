...
int main()
{
    // ---- 测试 1: 两个 PCI 设备 ----
    {
        RawStore raw;
        // 设备 1: NVIDIA GPU
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:41:00.0/vendor", "0x10de"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:41:00.0/device", "0x2322"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:41:00.0/class", "0x030000"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:41:00.0/numa_node", "0"));

        // 设备 2: Mellanox NIC
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:65:00.0/vendor", "0x15b3"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:65:00.0/device", "0x158b"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:65:00.0/class", "0x020000"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:65:00.0/numa_node", "1"));
    ...
    {
        RawStore raw;
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:01:00.0/vendor", "0x8086"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:01:00.0/device", "0x1528"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:01:00.0/class", "0x020000"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:01:00.0/numa_node", "-1"));
    ...
    {
        RawStore raw;
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/INVALID/vendor", "0x1234"));
    ...
    // ---- 测试 5: lspci 名称覆盖 sysfs device hex ----
    {
        RawStore raw;
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:41:00.0/vendor", "0x10de"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:41:00.0/device", "0x1b06"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:41:00.0/class", "0x030000"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:41:00.0/numa_node", "0"));
    ...
    {
        RawStore raw;
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:00:00.0/vendor", "0x8086"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:00:00.0/device", "0x09a2"));
        raw.records.push_back(make_record(RawSource::SysfsPci, "/sys/bus/pci/devices/0000:00:00.0/class", "0x088000"));
