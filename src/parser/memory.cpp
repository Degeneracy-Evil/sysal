...
namespace sysal::detail
{
    ...
    namespace
    {
            ...
            for(const auto &line : lines)
            {
                ...
                else if(key == "MemAvailable")
                {
                    ...
                    if(!parts.empty())
                    {
                        ...
                        {
                            warnings.push_back("parse_memory: MemAvailable 值解析失败: " + std::string(value));
                        }
                    }
                }
            }
        ...
        std::vector<DimmInfo> parse_udevadm_dimms(std::string_view payload, std::vector<std::string> &warnings,
